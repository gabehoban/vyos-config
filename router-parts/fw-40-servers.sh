...
set firewall ipv4 name servers-iot rule 40 action 'accept'
set firewall ipv4 name servers-iot rule 40 description 'Rule: Accept_MDNS'
set firewall ipv4 name servers-iot rule 40 destination port '5353'
set firewall ipv4 name servers-iot rule 40 protocol 'udp'
