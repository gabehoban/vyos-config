...
set firewall ipv6 forward filter rule 111 inbound-interface group 'IG_trusted'
set firewall ipv6 forward filter rule 111 outbound-interface group 'IG_trusted'
...
set firewall ipv6 forward filter rule 116 outbound-interface group 'IG_trusted'
set firewall ipv6 forward filter rule 121 action 'accept'
set firewall ipv6 forward filter rule 121 inbound-interface group 'IG_guest'
set firewall ipv6 forward filter rule 121 outbound-interface group 'IG_guest'
...
set firewall ipv6 forward filter rule 126 outbound-interface group 'IG_guest'
set firewall ipv6 forward filter rule 131 action 'accept'
set firewall ipv6 forward filter rule 131 inbound-interface group 'IG_iot'
set firewall ipv6 forward filter rule 131 outbound-interface group 'IG_iot'
...
set firewall ipv6 forward filter rule 136 outbound-interface group 'IG_iot'
set firewall ipv6 forward filter rule 141 action 'accept'
set firewall ipv6 forward filter rule 141 inbound-interface group 'IG_servers'
set firewall ipv6 forward filter rule 141 outbound-interface group 'IG_servers'
...
set firewall ipv6 forward filter rule 146 outbound-interface group 'IG_servers'
set firewall ipv6 forward filter rule 171 action 'accept'
set firewall ipv6 forward filter rule 171 inbound-interface group 'IG_lan'
set firewall ipv6 forward filter rule 171 outbound-interface group 'IG_lan'
...
set firewall ipv6 forward filter rule 176 outbound-interface group 'IG_lan'
